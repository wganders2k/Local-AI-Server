...
CPU-only service that handles Discord history ingestion and lore retrieval for the lore assistant. Uses ChromaDB as the vector store and `sentence-transformers/all-MiniLM-L6-v2` for embeddings. Zero VRAM impact.
