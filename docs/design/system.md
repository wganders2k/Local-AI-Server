...
The bot exposes three slash commands. Mention-based routing was removed in favour of slash commands (see [`discord-bot.md`](discord-bot.md) §1), and compound lore+mimic chains are not supported.
